<template>
  <div
    ...
    @keyup.esc="deactivate(false, $event)"
      ...
      <div
        ...
        <ul :id="`${id}-listbox`"
          ...
          <li v-if="multiple && max === internalValue.length"
              role="option"
              :id="`${id}-listbox-item-max-elements`"
              :aria-selected="activeOptionId === `${id}-listbox-item-max-elements`">
          ...
          <template v-if="!max || internalValue.length < max">
            <li v-if="showClearButton"
                class="multiselect__element clear-button"
                role="option"
                :id="`${id}-listbox-item-clear`"
                :aria-selected="activeOptionId === `${id}-listbox-item-clear`">
            ...
            <li v-for="(option, index) of filteredOptions"
                ...
                role="option"
                :id="`${id}-listbox-item-${index}`"
                :aria-selected="activeOptionId === `${id}-listbox-item-${index}`"
                :key="index">
              <span
          ...
          <li v-show="showNoResults && (filteredOptions.length === 0 && search && !loading)"
              role="option"
              :id="`${id}-listbox-item-no-result`"
              :aria-selected="activeOptionId === `${id}-listbox-item-no-result`">
            <span class="multiselect__option">
          ...
          <li v-show="showNoOptions && (options.length === 0 && !search && !loading)"
              role="option"
              :id="`${id}-listbox-item-no-options`"
              :aria-selected="activeOptionId === `${id}-listbox-item-no-options`">
            <span class="multiselect__option">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      activeOptionId () {
        return `${this.id}-listbox-item-${this.pointer}`
      }
    }
  }
</script>
